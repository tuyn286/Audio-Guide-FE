...
export default {
  ...
  methods: {
    async getStaff() {
      try {
        const response = await api.get('/nhan-vien/', {params: { page: this.page }});
    ...
    search() {
      try {
        api.get('/nhan-vien/', { params: { page: this.page, text: this.searchText } })
          .then((response) => {
            this.staffs = response.data.content;
            this.totalPages = response.data.page.totalPages;
    ...
    <div class="container mt-2 mb-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-9">
          <div class="row">
            <div class="col-6">
                <router-link class="btn btn-success" :to="{name: 'manager-add-staff'}">Thêm nhân viên</router-link>
            </div>
            <div class="col-6">
              <div class="d-flex">
                <form
