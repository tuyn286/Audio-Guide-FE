  ...
  <section>
    <div class="container mt-2">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><router-link :to="{name: 'admin-user'}">Vé thuyết minh</router-link></li>
        ...
        <div class="col-6">
          <div class="card">
            <div class="card-body">
              ...
              <p>Thuộc sở hữu của khu du lịch: <span class="text-success fw-bold">{{ticket.khuDuLich?.tenKhuDuLich}}</span></p>
